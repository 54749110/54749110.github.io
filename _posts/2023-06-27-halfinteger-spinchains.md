...
<img src="/assets/grouppresentation/1.png" width = "290" height = "80" alt="图片名称" align=center />
<img src="/assets/grouppresentation/2.png" width = "290" height = "80" alt="图片名称" align=center />

&emsp;&emsp; 下面两张图是四粒子的能量随$\alpha$的变化图，以及N较大时的上下两带能量，当粒子数趋于无穷时，带隙合拢，而此时基态每个自旋的能量为($\alpha=1/2$)&emsp; $-3/4 J$。

<img src="/assets/grouppresentation/3.png" width = "290" height = "200" alt="图片名称" align=center />
<img src="/assets/grouppresentation/4.png" width = "290" height = "170" alt="图片名称" align=center />
...
<img src="/assets/grouppresentation/7.jpg" width = "600" height = "160" alt="图片名称" align=center />
